...
function About() {
  return (
    <section className="container">
      ...
      <p>
        {' '}
        I earned a certificate in Full-Stack Web Development from the University
        of Texas at Austin’s Web Development Boot Camp with newly developed
      ...
      <p>
        I applied aspects of front-end development in a recent project. I worked
        on a team of five to develop an application that allows a travel
        enthusiast to create an account to log past, upcoming, and bucket-list
        trips.
      </p>
      <p>
        I enjoy working with a fast-paced, quality-driven team to provide
        creative solutions to complex problems and exceed project expectations.
      </p>
    </section>
  );
}
